...
const FOCUS_DIRECTIONS = [
  {
    ...
    sourceName: 'Báo Điện Tử CafeBiz',
    articleUrl: 'https://cafebiz.vn/khi-nguoi-nha-nuoc-noi-chuyen-bang-ngon-ngu-gen-z-176251010184241603.chn',
    ...
    modalTitle: 'Khi Người Nhà Nước Nói Chuyện Bằng Ngôn Ngữ Gen Z',
    modalDesc: 'Để chủ trương của Đảng và chính sách pháp luật của Nhà nước thẩm thấu tự nhiên vào giới trẻ, các cơ quan chức năng và tổ chức Đoàn đã chủ động thay đổi tư duy truyền thông: tạo ra các nội dung trực quan, hình ảnh minh họa gần gũi, video ngắn tương tác cao, "nói bằng ngôn ngữ của Gen Z" để lan tỏa lý tưởng sống tích cực.',
  },
  {
    icon: Users2,
    color: '#E8C84D',
  ...
  },
  {
    ...
    image: thachThucImg,
    sourceName: 'NXB Lý Luận Chính Trị',
    articleUrl: 'https://nxblyluanchinhtri.vn/nhan-dien-va-dau-tranh-voi-tin-gia-tren-khong-gian-mang-trach-nhiem-cua-thanh-nien-trong-ky-nguyen-so/',
    ...
    modalTitle: 'Nhận Diện Và Đấu Tranh Với Tin Giả Trên Không Gian Mạng',
    modalDesc: 'Trong kỷ nguyên số, các thế lực thù địch liên tục tung tin giả (fake news), cắt ghép video xuyên tạc nhằm xói mòn lòng tin của giới trẻ. Việc trang bị bản lĩnh chính trị và trách nhiệm của thanh niên giúp mỗi bạn trẻ chủ động nhận diện thông tin xấu độc, không bị dẫn dắt và tích cực bảo vệ nền tảng tư tưởng của Đảng trên không gian số.',
  },
];
